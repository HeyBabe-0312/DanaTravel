  ...
  translation: {
    ...
    reviews: {
      form: {
        ...
        shareExperience: "Chia sẻ trải nghiệm của bạn với những du khách khác",
        rating: "Đánh giá",
        reviewTitle: "Tiêu đề đánh giá",
        summarizeExperience: "Tóm tắt trải nghiệm của bạn",
        yourReview: "Đánh giá của bạn",
        tellUsExperience: "Hãy chia sẻ về trải nghiệm của bạn...",
      ...
      list: {
        ...
        beFirstToShare: "Hãy là người đầu tiên chia sẻ trải nghiệm của bạn!",
        pleaseLoginToLike: "Vui lòng đăng nhập để thích đánh giá",
        pleaseLoginToDislike: "Vui lòng đăng nhập để không thích đánh giá",
        like: "Thích",
        unlike: "Bỏ thích",
        dislike: "Không thích",
        removeDislike: "Bỏ không thích",
        edit: "Chỉnh sửa",
        delete: "Xóa",
      ...
      locationReviews: {
        ...
        reviews: "đánh giá",
        cancel: "Hủy",
        pleaseLoginToWrite: "Vui lòng đăng nhập để viết đánh giá",
      ...
      errors: {
        loadingReviews: "Lỗi khi tải đánh giá",
        submittingReview: "Lỗi khi gửi đánh giá",
        updatingReview: "Lỗi khi cập nhật đánh giá",
        deletingReview: "Lỗi khi xóa đánh giá",
        updatingLike: "Lỗi khi cập nhật thích",
        updatingDislike: "Lỗi khi cập nhật không thích",
